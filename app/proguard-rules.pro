...
-keep class com.devshiv.drivesafetyapp.model.** { *; }
-keepclassmembers class com.devshiv.drivesafetyapp.model.** { *; }

-keep class com.devshiv.drivesafetyapp.viewmodels.** { *; }
-keep class com.devshiv.drivesafetyapp.repository.** { *; }